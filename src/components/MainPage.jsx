                    ...
                    {distances.length > 0 && (
                      <>
                        <li className="list-group-item justify-content-center suggest-tab">
                          Main North Rd&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <img src={trafficSpeedIcon} alt="Traffic Speed Icon" style={{ width: "20px", height: "20px" }} />&nbsp;&nbsp;&nbsp;{trafficSpeeds.speed1} km/h
                        ...
                        <li className="list-group-item suggest-tab">
                          Airport Rd &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <img src={trafficSpeedIcon} alt="Traffic Speed Icon" style={{ width: "20px", height: "20px" }} />&nbsp;&nbsp;&nbsp;{trafficSpeeds.speed2} km/h &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
